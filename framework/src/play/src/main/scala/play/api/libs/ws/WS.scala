...
object WS {
  ...
  private[play] def newClient(): AsyncHttpClient = {
    ...
    val asyncHttpConfig = new AsyncHttpClientConfig.Builder()
      .setConnectionTimeoutInMs(wsTimeout.getOrElse(120000L).toInt)
      .setIdleConnectionTimeoutInMs(wsTimeout.getOrElse(120000L).toInt)
      .setRequestTimeoutInMs(wsTimeout.getOrElse(120000L).toInt)
